...
string FileInput = "images/Duck2.png";
string FileOutput = "iamges/Duck.png";
int countColorsResult = 20;
int wsm = 20;
int hsm = 15;
using (Image<Rgba32> image = Image.Load<Rgba32>(FileInput)) 
{
    ...
    /* using(Image<Rgba32> testImage = new Image<Rgba32>(60, 30))
    {
        ...
        testImage.SaveAsPng("test2.png");
    } */
    using (StreamWriter writer = new StreamWriter("images/threadsUsed.txt", false))
    {
    ...
    using(Image<Rgba32> testImage = new Image<Rgba32>(60, 30))
    {
        ...
        testImage.SaveAsPng("images/test2.png");
    }
